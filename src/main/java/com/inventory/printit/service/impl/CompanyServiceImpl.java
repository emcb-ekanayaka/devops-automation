...
public class CompanyServiceImpl implements CompanyService{
    ...
    public CommonResponseDto saveCompany(RequestRegistryDto dto) {
        Optional<Company> company = companyRepo.findCompanyByName(dto.getCompanyName());
        if (!company.isPresent()){
            ...
            return new CommonResponseDto(400, "Company Not Found! or already exist",0, new ArrayList<>());
        }
    }
